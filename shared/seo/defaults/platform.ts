...
export const PLATFORM_PAGE_SEO = {
  answer: {
    ...
    keywords: "回答引擎洞察,AI可见度,竞争分析,声量份额,GEO,{{siteName}},艾佩睿思",
  },
  topics: {
    label: "发现机会与差距",
    ...
    keywords: "增长机会,信源分析,话题发现,GEO策略,{{siteName}},艾佩睿思",
  },
  prompt: {
    label: "提示词查询探索",
    ...
    keywords: "提示词分析,查询扇出,Prompt探索,GEO,{{siteName}},艾佩睿思",
  },
  content: {
    label: "内容创作与优化",
    ...
    keywords: "AI内容创作,GEO内容优化,内容引擎,SEO,{{siteName}},艾佩睿思",
  },
