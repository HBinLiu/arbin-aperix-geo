...
export const SOLUTION_TEAM_SEO = {
  agencies: {
    ...
    keywords: "代理商GEO,多品牌管理,白标仪表盘,AI可见性,{{siteName}},艾佩睿思",
  },
  enterprise: {
    label: "大型企业",
    ...
    keywords: "企业GEO,品牌影响力,AI信任,高管仪表盘,{{siteName}},艾佩睿思",
  },
  "pr-brand-teams": {
    label: "公关与品牌团队",
    ...
    keywords: "公关GEO,品牌声誉,AI叙事,危机监测,{{siteName}},艾佩睿思",
  },
  "smb-geo-teams": {
    label: "中小企业 GEO 团队",
    ...
    keywords: "中小企业GEO,AI可见性,品牌信任,GEO团队,{{siteName}},艾佩睿思",
  },
  "seo-specialists": {
    label: "SEO 专家",
    ...
    keywords: "SEO专家,GEO工具,AI可见性追踪,竞争分析,{{siteName}},艾佩睿思",
  },
