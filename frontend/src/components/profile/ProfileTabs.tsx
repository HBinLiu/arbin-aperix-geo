...
import { PROFILE_TABS, profileTabPath } from "@/lib/profile/nav";
...
/** 账户设置 Tab：账户 / 成员 */
export function ProfileTabs({ value, className, embedded = false }: ProfileTabsProps) {
  const containerRef = useRef<HTMLDivElement>(null);
  const tabRefs = useRef(new Map<ProfileTab, HTMLAnchorElement>());
  const [hoverId, setHoverId] = useState<ProfileTab | null>(null);
