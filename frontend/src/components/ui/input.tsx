...
const inputGroupShellClass = cn(
  "border-input bg-white min-w-0 overflow-hidden rounded-md border",
...
export const inputControlClass = cn(
  "border-input bg-white w-full min-w-0 rounded-md border text-sm md:text-sm",
  ...
  cn(inputControlClass, "mx-0.5 flex file:border-0 file:bg-transparent file:text-sm file:font-medium"),
  {
    variants: {
      variant: {
        default: "",
        merged:
          "mx-0 border-0 bg-white shadow-none focus-visible:border-transparent focus-visible:shadow-none focus-visible:ring-0",
      },
      controlSize: {
