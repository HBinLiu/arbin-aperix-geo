...
from aperix_geo.services.competitor.doubao import (
    ...
    parse_doubao_competitors_payload,
)
...
def test_parse_skips_missing_website_url() -> None:
    text = """
    {"competitors": [
...
def test_discover_domain_returns_empty_when_doubao_fails(mock_doubao) -> None:
    from aperix_geo.services.competitor.discover import discover_domain_competitors

    mock_doubao.side_effect = RuntimeError("api down")

    result = discover_domain_competitors(_sample_profile(), "sheepgeo.com")
